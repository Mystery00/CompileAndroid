...
vim ~/LineageOS/frameworks/base/core/Java/android/provider/Settings.java
vim ~/LineageOS/frameworks/base/packages/SettingsProvider/res/values/defaults.xml
vim ~/LineageOS/frameworks/base/packages/SettingsProvider/src/com/android/providers/settings/DatabaseHelper.java
